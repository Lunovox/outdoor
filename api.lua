...
outdoor.canUse = function(pos, player)
	...
	--print("[outdoor.canUse] ownername = "..ownername)
	...
	minetest.register_node("outdoor:"..id, {
		...
		on_receive_fields = function(pos, formname, fields, sender)
			...
			elseif fields.selSimbol  then -- quests
				--minetest.chat_send_player(player:get_player_name(),"Voce selecionou o simbolo '"..selnum.."'!")
